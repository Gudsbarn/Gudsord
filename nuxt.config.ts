...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { property: 'og:site_name', content: 'gudsord Wallet'},
        ...
        { property: 'og:title', content: 'gudsord Wallet'},
        { property: 'og:url', content: process.env.API_WEBSITE_URL},
        { name: 'title' , content: 'gudsord Wallet'},
        ...
        { hid: 'gudsord', name: 'description', content: 'gudsord is a mobile wallet dedicated to offering solutions that are fast, secure, and reliable. Our services and specialties encompass payment and other financial services through the convenience of your own phone. With gudsord you can transfer funds, buy load, pay bills all at a touch of a button.' },
        { name: 'format-detection', content: 'telephone=no' },
        { name: 'keywords', content: 'gudsord, Gudsord, gudsord, wallet, mobile wallet, secure, e-wallet, toll, transfer, cash, cash in, cash out, bank,transfer funds, buy load, pay bills', lang: 'EN' }
      ],
    }
  },
  googleFonts: {
