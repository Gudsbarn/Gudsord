        ...
        <div class="relative flex items-center">
          ...
          <div class="relative hidden lg:flex items-center ml-auto">
            ...
            >
              <ul class="flex space-x-8">
                <li>
                  <a
                    class="hover:text-slate-50 dark:hover:text-primary-400"
                    href="/"
                    >Home</a
                  >
                </li>
                ...
                <!-- <li>
                  <a class="hover:text-sky-500 dark:hover:text-sky-400" href="/showcase">Showcase<span class="
                        ml-2
                        font-medium
                        text-xs
                        leading-5
            ...
            >
              ...
              >
                <span class="dark:hidden" @click="setColorMode('dark')">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke-width="2"
                  ...
                  >
                    <path
                      ...
                      class="stroke-slate-50 dark:stroke-slate-500"
                    ></path>
                    <path
                ...
                <span class="hidden dark:inline" @click="setColorMode('light')">
              ...
              <!-- <a href="https://github.com/tailwindlabs/tailwindcss" class="
                  ml-6
                  block
                  text-slate-100
          ...
          <div class="ml-auto -my-1 lg:hidden ml-auto flex flex-row">
            ...
            <div class="dropdown dropdown-end">
              ...
              >
                <li><a href="/">Home</a></li>
                <li><a href="/preaches">Preaches</a></li>
...
onMounted(() => {
  const mode =
    localStorage.getItem("nuxt-color-mode") == "dark" ? "dark" : "light";
  document.querySelector("html").setAttribute("data-theme", mode);
});
</script>
